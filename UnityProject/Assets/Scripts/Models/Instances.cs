...
namespace Waystation.Models
{
    ...
    public class MissionInstance
    {
        ...
        // Optional scout target metadata used by exploration/cartography missions.
        public int          targetSystemSeed = 0;
    ...
    [Serializable]
    public class ExplorationDatachipInstance
    {
        public string uid;
        public int    systemSeed;
        public string systemName;
        // Foundation uid currently holding the physical chip item.
        public string holderFoundationUid;
        // True when this chip is currently installed in a Cartography Server.
        public bool   installedInServer = false;

        public static ExplorationDatachipInstance Create(int systemSeed, string systemName)
        {
            return new ExplorationDatachipInstance
            {
                uid         = Guid.NewGuid().ToString("N")[..8],
    ...
    public class StationState
    {
        ...
        // Interstellar exploration points generated by powered Interstellar Antennae.
        public int explorationPoints = 0;
        // Physical exploration datachips keyed by chip uid.
        public Dictionary<string, ExplorationDatachipInstance> explorationDatachips =
            new Dictionary<string, ExplorationDatachipInstance>();
        // System seeds currently charted with full data from installed datachips.
        public HashSet<int> chartedSystemSeeds = new HashSet<int>();
